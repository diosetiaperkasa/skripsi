                    ...
                    <div class="navbar-header">
                        <a href="home.php" class="navbar-brand">
                          <div class="text-center">
                            ...
                            <img src="bandol.png"  alt="Nifty Logo" class="brand-icon" style="width: 80px;">
                            ...
                            <li id="dropdown-user" class="dropdown">
                                <a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
                                    <span class="pull-right">
                                        <img class="img-circle img-user media-object" src="img/bando.jpg" alt="Profile Picture">
                                    </span>
										...
										<li>
                                            ...
                                            <ul class="collapse">
                                                ...
                                                <li><a href="tampil_tagihan.php">Transaksi tagihan</a></li>
												 ...
												 <!-- <li><a href="laporan.php">Report penjualan (Apriori)</a></li>-->
