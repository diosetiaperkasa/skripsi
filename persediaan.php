...
<tr><td><select name="nama" class="form-control"/>
	...
	<?php  $data=mysql_query("select * from barang");
...
<br>
<div style="text-align:right;"><a href="excel_persediaan.php">Download Exel</a></div>
<h4>Laporan Persediaan PT.Bando Indonesia</h4>
