		...
		<div class="cls-header cls-header-lg">
			<div class="cls-brand">
				<a class="box-inline" href="index-2.html">
					...
					<span class="brand-title"><span class="text-thin">Terima Kasih Telah Menghubungi Kami </br>Kami akan proses Komplain anda</span></span>
				</a>
			</div>
		</div>
		<!--===================================================-->
		...
		<div class="cls-content">
			<div class="cls-content-sm panel">
				<div class="panel-body">
					<p class="pad-btm btn btn-danger"><a href="index.php">Ke halaman utama</a></p>
