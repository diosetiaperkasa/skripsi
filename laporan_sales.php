...
FROM
  ...
  INNER JOIN `salesman` ON `transaksi_detail`.`Sales` = `salesman`.`Id_Salesman` where `transaksi_detail`.Sales ='".$_POST['nama']. "'");
  //echo $list_transaksi;
...
<br>
<div style="text-align:right;"><a href="excel_sales.php">Download Exel</a></div>
<h4>Laporan Sales PT. Bando Indonesia</h4>
