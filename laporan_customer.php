...
<tr><td><select name="nama" class="form-control"/>
	...
	<?php  $data=mysql_query("select * from Customer");
...
<br>
<div style="text-align:right;"><a href="excel_customer.php">Download Exel</a></div>
<h4>Laporan Customer PT. Bando Indonesia</h4>
